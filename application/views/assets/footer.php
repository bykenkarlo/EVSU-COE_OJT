			...
			<ul class="list-inline">
				<li style="text-align: center; margin-left: 2em;">
					...
					<small class="social col-sm-12">
						By: <a style="color: #fff;" href="https://ph.linkedin.com/in/kenkarlopadal">Ken Karlo</a>
					</small>
				</li>			
				<!-- <li><a href="#"><img src="/EVSU_OJT/assets/images/linkedin.png" alt="linkedin" height="50" width="50"></a></li> -->
			</ul>
			<ul class="list-inline">

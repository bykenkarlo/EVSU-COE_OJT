...
<?php $comp_id = $dataspv['comp_id'] ?>
	...
	<div class="table_list" >
		...
		<div class="" style="margin-bottom: 15px">
			<h1 align="left"><span class="fa fa-users"></span> Trainee's Lists  <?= $datacomp['cname']?>  </h1>
		</div>
			 ...
			 foreach ($this->Login_user_model->get_all_student2($comp_id,$cdr_id) as $key): ?>
				<tr>
					...
					<td width="100">
						...
						<a href="<?php echo base_url();?>Control/delete_student_cdr/<?php echo $key['stud_id']; ?>" class="btn btn-danger btn-xs btnCircle fa fa-trash btn-sm" onclick="return confirm('Are you sure?')"></a>
					</td>
				</tr>
			<?php endforeach ?>
			</tbody>

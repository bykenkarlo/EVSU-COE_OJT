...
<div>
	<div class="table_list" >
		...
		<div class="" style="margin-bottom: 15px">
			<h1 align="left" class="hoverme"><span class="fa fa-users"></span> Unconfirmed Training Supervisors Accounts</h1>
		</div>
		...
		<form action="<?= base_url()?>Control/delete_spv_list" method="POST"> 
					...
					<tbody>
					<?php foreach ($this->Login_user_model->get_all_spv_inactive() as $key): ?>
						<tr>
							...
							<td><?= $key['date_reg']?></td>
							<td>
							<a href="<?= base_url(); ?>Login/confirmAccount/<?php echo $key['spv_id']; ?>" class="btn btn-success btn-xs btnCircle fa fa-check"></a>

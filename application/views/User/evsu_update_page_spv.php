...
<div class="" id="table_list" style="margin: 10px 0px 10px 0px; background: #fff; border-radius: 2px; padding: 5px 15px 15px 15px; box-shadow: 0 1px 2px 1px rgba(0, 0, 0, 0.2), 0 1px 2px 0 rgba(0, 0, 0, 0.1);" >
	<div>
		<h1 style="font-weight: ; padding: 20px 40px 10px 50px; margin-top: 10px; "><span class="glyphicon glyphicon-share"></span> Update Profile</h1>
			...
			<form  class="form-horizontal" action="<?php echo base_url();?>Login/update_spv" method="POST">							
					...
					<div class="form-group">	
						...
						<div class="col-sm-4">
								<select name="cname" class="form-control" value="Course" readonly>
								
										<option value=""><?= $info['cname'] ?></option>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Email Address</label>						
							<div class="col-sm-8">
								<input type="email" name="email" class="form-control" value="<?= $info['email_address'];?>" required>
							...
							<div class="form-group">	
								...
								<div class="col-sm-8">
									<div class="input-group">
										...
										<input type="text" name="telnum" class="form-control" value="<?= $info['telNum'];?>" required>		
									</div>
								</div>
							</div>

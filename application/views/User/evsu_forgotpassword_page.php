	...
	<div class="col-sm-7 col-md-offset-3 " id="reg_user">
		<div id="reg_form" class="panel">
			<div class="panel-heading panel_head">
				<h2><span class="fa fa-envelope"></span> Enter Your Email Address</h2>
			</div>
			<div class="panel-body">
			<?= $this->session->flashdata('message') ?>
				<form class="form-horizontal" action="<?php echo base_url();?>Control/resetPassword" method="POST">
					<div class="form-group">
						<label class="col-sm-3 control-label text-capitalize">Email Address</label>						
						<div class="col-sm-9 form_lname">
							<input type="email" name="to" class="form-control " placeholder="Email Address" required  >
						</div>
					</div>	
					
					<div class="pull-right">
						<input type="submit" class="btn btn-primary btn-xm" value="Send">
					</div>	

...
<div>
	<div class="table_list" >
		...
		<div class="" style="margin-bottom: 15px">
			<h1 align="left"><span class="fa fa-envelope"></span> Send to Confirm Account</h1>
		</div>
		<div style="margin-bottom: 10px;">
			...
			<?php $accountInfo = $this->Login_user_model->get_spv_confirm($data)?>

		<div class="">
		<div class="container">
			<div class="col-sm-7 col-md-offset-2 " id="reg_user">
				<div id="" class="panel comfirmemail">
					<div class="panel-heading panel_head">
						<h2><span class="fa fa-check"></span> Confirm Account</h2>
					</div>
					<div class="panel-body">
					<?= $this->session->flashdata('message') ?>
						<form class="form-horizontal" action="<?php echo base_url();?>Login/sendtoConfirm" method="POST">
						<input type="hidden" name="spv_id" value="<?=$accountInfo['spv_id']?>">
						<input type="hidden" name="hash" value="<?=$accountInfo['hash']?>">
							<div class="form-group">
								<label class="col-sm-3 control-label text-capitalize">Full Name</label>						
								<div class="col-sm-9 form_lname">
									<input type="text" name="fullname" class="form-control text-capitalize" value="<?= $accountInfo['fname'].' '.$accountInfo['lname']?>" placeholder="Name" required  >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label text-capitalize">Email Address</label>						
								<div class="col-sm-9 form_lname">
									<input type="email" name="to" class="form-control " value="<?= $accountInfo['email_address']?>" placeholder="Email Address" required  >
								</div>
							</div>	
							
							<div class="pull-right">
								<button type="submit" class="btn btn-primary btn-xm"><span class="fa fa-send"></span> Send</button>
							</div>	

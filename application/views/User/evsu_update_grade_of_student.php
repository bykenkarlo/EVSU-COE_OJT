...
<div class="" id="table_list" style="margin: 10px 0px 10px 0px; background: #fff; border-radius: 2px; padding: 5px 15px 15px 15px; box-shadow: 0 1px 2px 1px rgba(0, 0, 0, 0.2), 0 1px 2px 0 rgba(0, 0, 0, 0.1);" >
	<div>
		...
		<?php $info = $this->Login_user_model->get_stud_info_grades($stud_id); ?>
			<form  class="form-horizontal" action="<?php echo base_url();?>Login/update_student_grade" method="POST">									 
					...
					<div class="form-group">	
						...
						<div class="col-sm-8">
							<input type="text" name="fullname" class="form-control text-capitalize" value="<?= $info['fullname'];?>" readonly >
						</div>
					</div>
					...
					<div class="form-group">	
						...
						<div class="col-sm-4">
							<input type="text" name="cdr_grade" class="form-control text-capitalize" value="<?= $info['cdr_grade']?>" required >
						</div>
					</div>
					<div class="form-group">	
						<label class="col-sm-3 control-label">Supervisor's Grade</label>
						<div class="col-sm-4">
							<input type="text" name="spv_grade" class="form-control text-capitalize" value="<?= $info['spv_grade']?>" required readonly>
						</div>
					</div>
					<div class="form-group">	
						<label class="col-sm-3 control-label">Peer to Peer's Grade</label>
						<div class="col-sm-4">
							<input type="text" name="PTPgrade" class="form-control text-capitalize" value="<?= $info['PTPgrade']?>" readonly required >
						</div>
					</div>
					<div class="form-group">	
						<label class="col-sm-3 control-label">Self Evaluation</label>
						<div class="col-sm-4">
							<input type="text" name="selfgrade" class="form-control text-capitalize" value="<?= $info['selfgrade']?>" readonly required >
						</div>
					</div>
					...
					<div class="pull-right" style="margin-right: 95px; margin-bottom: 20px; ">
						...
						<a href="<?php echo base_url();?>Login/student_grade_list"><button type="button" class="btn btn-danger btn-lg btnCancel"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</button></td></a>
					</div>	
		</form>	
	</div>
</div>

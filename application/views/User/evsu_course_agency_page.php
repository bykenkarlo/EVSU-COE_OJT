...
<div class="col-sm-12 " >
	...
	<div class="blockquote" style="margin-bottom: 30px">
		<h1 class="hoverme"><span class="fa fa-users"></span> List of Courses</h1>
	...
	<div class="table-responsive">
		<form action="<?= base_url()?>Control/deleteCourseList" method="POST">
			...
			<tbody >
				...
				<tr>
					<td width="1"><input type="checkbox" name="delete_course[]" value="<?= $key['course_id'] ?>" id="selector"></td>
					...
					">
						...
						<a href="<?php echo base_url();?>Control/deleteCourse/<?php echo $key['course_id']; ?>" class="btn btn-danger btn-xs btnCircle fa fa-trash" onclick="return confirm('Are you sure to delete this?')"></a>
					</td>
				</tr>
				<?php endforeach ?>
			</tbody>
